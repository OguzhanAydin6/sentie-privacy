...
Any image you capture or select is used only for real-time analysis and is discarded when the session ends.

---

## 3. Scan History & Local Storage
When you choose to save an analysis:
- Only **non-image data** (such as aura colors, whisper score, and analysis results) is stored
...
- Access and delete your locally stored data
